...
<div class="container">
    <div class="intro">
        <h1>First Choice Main Banners</h1>
    </div>       
</div>
<?php    
$xml=simplexml_load_file("firstChoice/MainBanners.xml") or die("Error: Cannot create object");
    ...
    <div class="container">
     ...
     <h1><?php echo $B->title ?></h1>
        ...
        <div class="row">
             <div class="col-md-8">
             <div class="well">
                 <iframe scrolling="no" src="firstChoice/mainBanners/<?php echo $B->html ?>" width="<?php echo $B->width ?>" height="<?php echo $B->height ?>"></iframe>    
             </div> 
            </div>
            <div class="col-md-4">
                 <div class="well pad">
                    <iframe src="firstChoice/mainBanners/<?php echo $B->html ?>" width="340" height="<?php echo $B->height ?>"></iframe>
                </div>
            </div>
